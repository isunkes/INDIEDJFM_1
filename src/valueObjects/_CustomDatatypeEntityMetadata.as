...
internal class _CustomDatatypeEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("imageBig", "mixImageBig", "djID", "mixFile", "mixDesc", "mixID", "mixYear", "imageSmall", "mixcount", "mixName", "mixGenre", "bio", "djName", "promoImage", "mixLen", "promoSectionName");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("imageBig", "mixImageBig", "djID", "mixFile", "mixDesc", "mixID", "mixYear", "imageSmall", "mixcount", "mixName", "mixGenre", "bio", "djName", "promoImage", "mixLen", "promoSectionName");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("imageBig", "mixImageBig", "djID", "mixFile", "mixDesc", "mixID", "mixYear", "imageSmall", "mixcount", "mixName", "mixGenre", "bio", "djName", "promoImage", "mixLen", "promoSectionName");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("imageBig", "mixImageBig", "djID", "mixFile", "mixDesc", "mixID", "mixYear", "imageSmall", "mixcount", "mixName", "mixGenre", "bio", "djName", "promoImage", "mixLen", "promoSectionName");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("imageBig", "mixImageBig", "djID", "mixFile", "mixDesc", "mixID", "mixYear", "imageSmall", "mixcount", "mixName", "mixGenre", "bio", "djName", "promoImage", "mixLen", "promoSectionName");
