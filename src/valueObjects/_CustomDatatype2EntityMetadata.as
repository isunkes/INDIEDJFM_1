...
internal class _CustomDatatype2EntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("genre", "mixImageBig", "djID", "mixFile", "mixDesc", "mixID", "mixYear", "imageSmall", "mixcount", "bio", "mixName", "mixGenre", "djName", "promoImage", "mixLen", "promoSectionName");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("genre", "mixImageBig", "djID", "mixFile", "mixDesc", "mixID", "mixYear", "imageSmall", "mixcount", "bio", "mixName", "mixGenre", "djName", "promoImage", "mixLen", "promoSectionName");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("genre", "mixImageBig", "djID", "mixFile", "mixDesc", "mixID", "mixYear", "imageSmall", "mixcount", "bio", "mixName", "mixGenre", "djName", "promoImage", "mixLen", "promoSectionName");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("genre", "mixImageBig", "djID", "mixFile", "mixDesc", "mixID", "mixYear", "imageSmall", "mixcount", "bio", "mixName", "mixGenre", "djName", "promoImage", "mixLen", "promoSectionName");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("genre", "mixImageBig", "djID", "mixFile", "mixDesc", "mixID", "mixYear", "imageSmall", "mixcount", "bio", "mixName", "mixGenre", "djName", "promoImage", "mixLen", "promoSectionName");
    ...
    public function _CustomDatatype2EntityMetadata(value : _Super_CustomDatatype2)
    {
        ...
        model_internal::propertyTypeMap["genre"] = "Object";
